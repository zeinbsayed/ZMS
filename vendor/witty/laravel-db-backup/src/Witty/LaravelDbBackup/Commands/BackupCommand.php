...
class BackupCommand extends BaseCommand 
{
	...
	public function fire()
	{
		...
		$contents = Storage::get('dumps/'. $this->fileName);
		$encrypted_backup=Crypt::encrypt($contents);
		Storage::put('dumps/'.$this->fileName, $encrypted_backup);
		Session::put('backup_file',storage_path().'/dumps/'.$this->fileName);
		//Storage::put('dumps/asd.txt', "ASD");
		//Storage::get('dumps/asd.txt');
		// S3 Upload
		//----------------
