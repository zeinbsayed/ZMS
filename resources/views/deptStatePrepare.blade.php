			  ...
			  <div class="box box-primary" dir="rtl">
				...
				<!--{!! Form::open(array('class'=>'form','id'=>'patient_form', 'name'=>'patient_form')) !!}!-->
				  <div class="box-body">
					...
					<div class="row">
					<form action="{{url('/patients/deptstateReport')}}" method="post">
					{{ csrf_field() }}
						<div class="col-lg-6" style="float:left">
						{!! Form::label('����� ������',null,array('id'=>'entry_date')) !!}
							<div class="form-group @if($errors->has('fromdate')) has-error @endif">
								{!! Form::label('����� ������',null,array('style'=>'color:red')) !!}
							...
							<a class="btn btn-info" href="{{ url('/patients/selectdept') }}">���� <i class="fa fa-trash"></i></a>
						 </div>
						 <div class="col-lg-6">
							...
							<br>
							<br>
							<!--<input type="checkbox" name="dept[]" value="1" id="test"> {!! Form::label('����� ') !!} <br><br>
							<input type="checkbox" name="dept[]" value="2" id="test2"> {!! Form::label('  �����') !!} <br><br>
							<input type="checkbox" name="dept[]" value="3" id="test3"> {!! Form::label('�����') !!} <br><br>
							<input type="checkbox" name="dept[]" value="3" id="test3"> {!! Form::label('�����') !!}<br><br>!-->
							@if ($errors->has('test'))<span class="help-block">{{$errors->first('test')}}</span>@endif
							@foreach($data as $dept)
							<input type="checkbox" name="dept[]" id="test" value="{{$dept->id}}">  {{$dept->name}} <br><br>
							@endforeach
							</form>
							<!--<button type="submit" class="btn btn-primary">��� <i class="fa fa-search"></i> </button>!-->
							<!--<a class="btn btn-info" href="{{ url('/getstat') }}">����</a>!-->
						</div>
						</div>
					</div>
					<div>
...
function calculateBOD(sid){
	...
	$("#datepicker").val(date);
	$("#age").val(diffYears+" ��� -"+diffMonths+" ��� -"+diffDays+" ��� ");
}
