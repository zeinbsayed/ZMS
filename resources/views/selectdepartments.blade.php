			  ...
			  <div class="box box-primary" dir="rtl">
				...
				<!--{!! Form::open(array('class'=>'form','id'=>'patient_form', 'name'=>'patient_form')) !!}!-->
				  <div class="box-body">
					...
					<div class="row">
					<form action="{{url('/patients/getstat')}}" method="post">
					{{ csrf_field() }}
						<div class="col-lg-6" style="float:left">
						{!! Form::label('تاريخ الدخول',null,array('id'=>'entry_date')) !!}
							...
							<a class="btn btn-info" href="{{ url('/patients/selectdept') }}">جديد <i class="fa fa-trash"></i></a>
						 </div>
						 <div class="col-lg-6">
							...
							<br>
							<br>
							<!--<input type="checkbox" name="dept[]" value="1" id="test"> {!! Form::label('باطنة ') !!} <br><br>
							<input type="checkbox" name="dept[]" value="2" id="test2"> {!! Form::label('  صدرية') !!} <br><br>
							<input type="checkbox" name="dept[]" value="3" id="test3"> {!! Form::label('جراحة') !!} <br><br>
							<input type="checkbox" name="dept[]" value="3" id="test3"> {!! Form::label('جراحة') !!}<br><br>!-->
							...
							<!--<a class="btn btn-info" href="{{ url('/getstat') }}">جديد</a>!-->
						</div>
						</div>
					</div>
					<div>
