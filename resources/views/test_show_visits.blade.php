								  ...
								  @if($role_name  == 'Entrypoint' || isset($ticket_and_entry))
									...
									<th style="text-align:center">جهة التعاقد</th>
									  @if($role_name  != 'Receiption')
										...
										@if((!is_null($sub_type_entrypoint)) &&( ($sub_type_entrypoint == "entry_only" || $sub_type_entrypoint == "update_only" || $sub_type_entrypoint == "entry_and_exit")))
										...
										<!-- <td>@if($row->closed == true) {{$row->updated_at}} @endif</td> -->
											@if((!is_null($sub_type_entrypoint)) && ($sub_type_entrypoint == "entry_only"  || $sub_type_entrypoint == "update_only" || $sub_type_entrypoint == "entry_and_exit"))
											 ...
											 <td style="text-align:center">
												...
												@if($row->closed == true && ($sub_type_entrypoint == "entry_only" ||$sub_type_entrypoint == "update_only"))
											 ...
											 <td style="text-align:center">
												...
												@if($row->closed == true && $sub_type_entrypoint == "entry_only"))
													class="btn btn-primary disabled" title="التحويل الى قسم اخر"
												@else
